...
tags: ['AI']
draft: false
summary: Forecasting updates to substances and regulations using AI
---
...
<figure>
  <img src="/static/images/blog/2021-10-18-horizon-scanning/models.png" width="90%" />
</figure>
...
<figure>
  <img src="/static/images/blog/2021-10-18-horizon-scanning/pipeline.png" />
</figure>
...
<figure>
  <img
    src="/static/images/blog/2021-10-18-horizon-scanning/substance_id_1_updates_62_annotated.png"
    alt="Horizon scanning app"
  />
</figure>
...
1. <a
     ...
     target="_blank"
   >
     Useful blog post about Poisson distribution and Poisson process
   </a>
2. <a
     href="https://medium.com/@ns2586/using-poisson-distribution-to-forecast-the-next-earthquake-38a4406ab71#:~:text=It%20is%20one%20prominent%20way,statistical%20distribution%20called%20Poisson%20Distribution.&text=It%20is%20a%20discrete%20probability,interval%20of%20time%20or%20space"
     target="_blank"
   >
     Useful blog post, predicts next earthquake
   </a>
